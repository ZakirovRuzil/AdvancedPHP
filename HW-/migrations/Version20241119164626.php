 ...
 */
final class Version20241119164626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE grade (id SERIAL NOT NULL, student_id INT NOT NULL, value INT NOT NULL, PRIMARY KEY(id))');
